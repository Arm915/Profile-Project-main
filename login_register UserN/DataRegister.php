...
$Cpassword = mysqli_real_escape_string($conn, $_POST['Cpassword']); 
    ...
    $error = "<br> ไม่สามารถสมัคได้เนื่องจาก <br>".$error;
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $query = "INSERT INTO regis (username, surname, email, rank, branch, Pass) VALUES ('$name', '$surname', '$email', '$rank', '$branch', '$hashedPassword')";
            if (!mysqli_query($conn, $query)){
                ...
                header("Location: http://localhost/Profile-Project-main/Home/Home-UserN/N-Home-Teach-N.php");  
                }
            }
        }  
    }
