...
if (isset($_POST['edita'])) {
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        // ตรวจสอบว่ามีการอัปโหลดไฟล์ PDF ใหม่หรือไม่
        ...
        if (!empty($updateFields)) {
            ...
            if (mysqli_query($conn, $updateQuery)) {
                header("Location: Admin-Home-Art&service-N.php");
                exit();
            }
        } 
    }
...
<body>
    <div class="container">
        ...
        <a href="Admin-Home-Art&service-N.php" class="backBtn">ย้อนกลับ</a>
    ...
    function deleteRowa($id) {
        ...
        if (!empty($id)) {
            ...
            if ($conn->query($sql) === TRUE) {
                echo '<script>window.location.href = "Admin-Home-Art&service-N.php";</script>';
            } 
        }
    }
