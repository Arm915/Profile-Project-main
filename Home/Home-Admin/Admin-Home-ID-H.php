...
<html lang="en">
  ...
  ?>
    ...
    <?php include('Admin-sidebar.php'); ?>
      <div class="art">
        <h4 class="art_section">Administration : บัญชีเยี่ยมชม
        <div class="box">
            <form name="search">
              ...
              $result2 = mysqli_query($conn, $sql2);
                  ...
                  while ($row2 = mysqli_fetch_assoc($result2)) {
                          ...
                          <tr>
                              ...
                              <td class="conbut2"><a href="Admin-from-Login-edit-H.php?id=<?php echo $row2['Id']; ?>" class="button3">แก้ไข</a></td>
                          </tr>
                          <?php
                      }
