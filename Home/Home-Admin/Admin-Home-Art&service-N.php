...
<html lang="en">
  ...
  ?>
    ...
    <?php include('Admin-sidebar.php'); ?>
      <div class="art">
        <h4 class="art_section">Administration : ศิลปะวัฒนะธรรม&บริการวิชาการ
        <div class="box1">
                  ...
                  while ($row2 = mysqli_fetch_assoc($result2)) {
                      ...
                      if ($id_identity == $id) {
                          ...
                          <tr>
                            ...
                            <th class="conbut2"><a href="Admin-from-Art&service-edit.php?id=<?php echo $row1['id']; ?>" class="button3">แก้ไข</a></th>
                          </tr>
                          <?php
                          break;
                      }
