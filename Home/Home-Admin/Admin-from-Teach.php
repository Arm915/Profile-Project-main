    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (!empty($updateFields)) {
            ...
            if (mysqli_query($conn, $updateQuery)) {
                header("Location: Admin-Home-Teach-N.php");
                exit();
            }
            else{
...
<body>
    <div class="container">
        ...
        <a href="Admin-Home-Teach-N.php" class="backBtn">ย้อนกลับ</a>
    ...
    function deleteRowT($id) {
        ...
        if (!empty($id)) {
            ...
            if ($conn->query($sql) === TRUE) {
                echo '<script>window.location.href = "Admin-Home-Teach-N.php";</script>';
            } 
        }
    }
